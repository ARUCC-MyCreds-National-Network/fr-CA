...
[MesCertif<sup>MC</sup>](www.mescertif.ca) offre aux étudiantes et aux étudiants un accès rapide et facile à leurs microcertifications et autres diplômes officiels d'établissements d'enseignement supérieur canadiens. MesCertif<sup>MC</sup> permet aux étudiantes, aux étudiants, aux diplômées et aux diplômés d’accéder à un portail numérique sécurisé, à partir duquel ils sont en mesure de consulter leurs documents d’études officiels et certifiés et d’en partager l’accès au moment qui leur convient, en toute simplicité.

## À propos du projet

Le [projet MyCreds<sup>TM</sup>| MesCertif<sup>MC</sup> du passeport virtuel de compétences pour les microcertifications](https://mescertif.ca/2022/08/29/passeport-virtuel-de-competences-pour-les-microcertifications-en-ontario/) est un projet de création d’attestations vérifiables pour les dossiers académiques d’établissements d’enseignement postsecondaire canadiens.
...
Pour ce projet, Digitary, en collaboration avec MATTR et l’ARUCC, assure la mise en place d’une chaîne de valeur complète de certificats numériques. La technologie Digitary CORE alimente le réseau national MesCertif<sup>MC</sup> de l’ARUCC.
